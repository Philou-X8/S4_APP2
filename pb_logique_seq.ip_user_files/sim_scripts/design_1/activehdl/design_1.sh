...
#
# Generated by Vivado on Tue Jan 16 11:48:38 -0500 2024
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/rosj2103/Downloads/pb_logique_seq/pb_logique_seq.cache/compile_simlib/activehdl"
  fi
