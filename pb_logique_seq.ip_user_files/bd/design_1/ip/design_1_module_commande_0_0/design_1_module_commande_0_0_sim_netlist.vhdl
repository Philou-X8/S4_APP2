...
--               f:/Xilinx/Projects/S4_APP2/pb_logique_seq.gen/sources_1/bd/design_1/ip/design_1_module_commande_0_0/design_1_module_commande_0_0_sim_netlist.vhdl
...
entity design_1_module_commande_0_0_conditionne_btn_v7 is
  port (
    ...
    \q2_btn_reg[0]_0\ : out STD_LOGIC;
    \q1_btn_reg[1]_0\ : out STD_LOGIC;
    \q1_btn_reg[3]_0\ : out STD_LOGIC;
    clk : in STD_LOGIC;
...
architecture STRUCTURE of design_1_module_commande_0_0_conditionne_btn_v7 is
  ...
  signal q2_btn : STD_LOGIC_VECTOR ( 3 downto 1 );
  ...
  attribute SOFT_HLUTNM of \state_next[1]_i_4\ : label is "soft_lutpair0";
begin
  Q(0) <= \^q\(0);
...
\state_next[1]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"22F2"
    )
        port map (
...
architecture STRUCTURE of design_1_module_commande_0_0_module_commande is
  signal inst_cond_btn_n_5 : STD_LOGIC;
  signal inst_cond_btn_n_6 : STD_LOGIC;
  signal inst_cond_btn_n_7 : STD_LOGIC;
  signal \^o_btn_cd\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \^o_selection_fct\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal q2_btn : STD_LOGIC_VECTOR ( 0 to 0 );
...
\state_current_reg[0]\: unisim.vcomponents.FDCE
     port map (
      C => clk,
      CE => '1',
      CLR => i_btn(3),
...
\state_current_reg[1]\: unisim.vcomponents.FDCE
     port map (
      C => clk,
      CE => '1',
      CLR => i_btn(3),
...
\state_next_reg[0]\: unisim.vcomponents.FDCE
     port map (
      C => clk,
      CE => '1',
      CLR => i_btn(3),
...
\state_next_reg[1]\: unisim.vcomponents.FDCE
     port map (
      C => clk,
      CE => '1',
      CLR => i_btn(3),
