...
HD_PWD='F:/Xilinx/Projects/S4_APP2/pb_logique_seq.runs/design_1_calcul_param_1_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_calcul_param_1_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_calcul_param_1_0_1.tcl
