...
# module references:
# affhexPmodSSD_v3, sig_fct_sat_dure, sig_fct_sat_dure, sig_fct_3, calcul_param_2, calcul_param_3, module_commande, mux4, mux4, mef_decod_i2s_v1b, compteur_nbits, reg_24b, reg_24b, reg_dec_24b, calcul_param_1, compteur_nbits, reg_8b, compteur_nbits, mef_cod_i2s_vsb, mux2, reg_dec_24b_fd
...
# Hierarchical cell: M5_param_1
proc create_hier_cell_M5_param_1 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_M5_param_1() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir I -from 23 -to 0 i_ech
  create_bd_pin -dir I i_en
  create_bd_pin -dir O -from 7 -to 0 o_param
  create_bd_pin -dir I -type rst reset

  # Create instance: calcul_param_1_0, and set properties
  set block_name calcul_param_1
  set block_cell_name calcul_param_1_0
  if { [catch {set calcul_param_1_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $calcul_param_1_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: reg_8b_0, and set properties
  set block_name reg_8b
  set block_cell_name reg_8b_0
  if { [catch {set reg_8b_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $reg_8b_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_net -net reset_1 [get_bd_pins reset] [get_bd_pins calcul_param_1_0/i_reset] [get_bd_pins reg_8b_0/i_reset]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: M5_param_1
  create_hier_cell_M5_param_1 [current_bd_instance .] M5_param_1
  ...
  connect_bd_net -net M5_param_1_o_param [get_bd_pins M5_param_1/o_param] [get_bd_pins Multiplexeur_choix_parametre/input1]
  ...
  connect_bd_net -net clk_1 [get_bd_ports clk_100MHz] [get_bd_pins M10_conversion_affichage/clk] [get_bd_pins M1_decodeur_i2s/clk] [get_bd_pins M5_param_1/clk] [get_bd_pins M6_parametre_2/i_bclk] [get_bd_pins M7_parametre_3/i_bclk] [get_bd_pins M8_commande/clk] [get_bd_pins M9_codeur_i2s/i_bclk]
  ...
  connect_bd_net -net decodeur_i2s_o_str_dat [get_bd_pins M1_decodeur_i2s/o_str_dat] [get_bd_pins M5_param_1/i_en] [get_bd_pins M6_parametre_2/i_en] [get_bd_pins M7_parametre_3/i_en]
  ...
  connect_bd_net -net i_dat_right_1 [get_bd_pins M5_param_1/i_ech] [get_bd_pins M6_parametre_2/i_ech] [get_bd_pins M7_parametre_3/i_ech] [get_bd_pins M9_codeur_i2s/i_dat_right] [get_bd_pins Multiplexeur_choix_fonction/output0]
  ...
  connect_bd_net -net i_reset_1 [get_bd_pins M10_conversion_affichage/reset] [get_bd_pins M1_decodeur_i2s/i_reset] [get_bd_pins M5_param_1/reset] [get_bd_pins M6_parametre_2/i_reset] [get_bd_pins M7_parametre_3/i_reset] [get_bd_pins M8_commande/o_reset] [get_bd_pins M9_codeur_i2s/i_reset]
