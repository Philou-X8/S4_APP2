...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity M5_param_1_imp_1W7ZI9M is
  port (
    clk : in STD_LOGIC;
...
end M5_param_1_imp_1W7ZI9M;

architecture STRUCTURE of M5_param_1_imp_1W7ZI9M is
  component design_1_reg_8b_0_0 is
  port (
    i_clk : in STD_LOGIC;
    i_reset : in STD_LOGIC;
    i_en : in STD_LOGIC;
  ...
  end component design_1_reg_8b_0_0;
  ...
  component design_1_calcul_param_1_0_1 is
  port (
    i_bclk : in STD_LOGIC;
    i_reset : in STD_LOGIC;
    i_en : in STD_LOGIC;
  ...
  signal i_ech_1 : STD_LOGIC_VECTOR ( 23 downto 0 );
  signal i_en_1 : STD_LOGIC;
  signal reg_8b_0_o_dat : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal reset_1 : STD_LOGIC;
begin
  clk_100MHz_1 <= clk;
  i_ech_1(23 downto 0) <= i_ech(23 downto 0);
  i_en_1 <= i_en;
  o_param(7 downto 0) <= reg_8b_0_o_dat(7 downto 0);
  reset_1 <= reset;
...
compteur_nbits_0: component design_1_compteur_nbits_0_2
     port map (
      clk => clk_100MHz_1,
      i_en => i_en_1,
      o_val_cpt(7 downto 0) => compteur_nbits_0_o_val_cpt(7 downto 0),
      reset => calcul_param_1_0_o_cpt_bit_reset
    );
...
architecture STRUCTURE of design_1 is
  ...
  signal M5_param_1_o_param : STD_LOGIC_VECTOR ( 7 downto 0 );
...
M5_param_1: entity work.M5_param_1_imp_1W7ZI9M
     port map (
      clk => clk_1,
      i_ech(23 downto 0) => i_dat_right_1(23 downto 0),
      i_en => decodeur_i2s_o_str_dat,
      o_param(7 downto 0) => M5_param_1_o_param(7 downto 0),
      reset => i_reset_1
    );
...
Multiplexeur_choix_parametre: component design_1_mux4_0_1
     port map (
      ...
      input1(7 downto 0) => M5_param_1_o_param(7 downto 0),
